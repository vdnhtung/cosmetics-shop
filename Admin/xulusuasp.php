<?php 
    ...
    if($hinhanh == null)
    {
        $sql = "UPDATE sanpham SET Ten='$name', HinhAnh='$anh', Manhasx= '$manhasx', date='$ngay',Gia='$gia', 
        ...
        $sql = "UPDATE sanpham SET Ten='$name', HinhAnh='$hinhanh', Manhasx= '$manhasx', date='$ngay',Gia='$gia',  
        KhuyenMai='$khuyenmai ', Mota='$mota',giakhuyenmai ='$giakhuyenmai'
        WHERE id= '$id ' " ;
        if ($conn->query($sql) === TRUE) {
            header('Location: qlysanpham.php');
